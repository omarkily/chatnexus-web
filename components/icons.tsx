...
// Sidebar Icons
export const OverviewIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    height={size || height}
    width={size || width}
    viewBox="0 0 24 24"
...
export const IntegrationsIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const AnalyticsIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    height={size || height}
    width={size || width}
    viewBox="0 0 24 24"
...
export const ChatsIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    height={size || height}
    width={size || width}
    viewBox="0 0 24 24"
...
export const KnowledgeBaseIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const SupportIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    height={size || height}
    width={size || width}
    viewBox="0 0 24 24"
